...
L’obiettivo finale è costruire un ambiente simulato realistico in cui due manipolatori (basati su modelli KUKA iiwa) eseguono compiti di pick-and-place all’interno di una cella dotata di oggetti e ostacoli tridimensionali.
